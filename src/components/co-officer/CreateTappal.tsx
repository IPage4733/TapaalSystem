...
const CreateTappal: React.FC = () => {
  ...
  // Get officers who can be assigned (excluding co_officer)
  const availableOfficers = mockUsers.filter(u => u.role !== 'co_officer');
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs text-gray-500">(Visible only to you and Collector)</span>
              </div>
            </div>
          </div>
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-xl p-6">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-medium text-purple-800 mb-2">Tappal Creation Guidelines</h3>
            <div className="text-purple-700 space-y-1">
              ...
              <p>• <strong>Confidential Marking:</strong> Use for sensitive matters (visible only to you and Collector)</p>
