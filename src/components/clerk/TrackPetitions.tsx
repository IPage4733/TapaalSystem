    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex items-center space-x-3">
          <ScrollText className="h-8 w-8 text-orange-600" />
          <div>
              ...
              {filteredPetitions.map((petition) => (
                <tr key={petition.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm font-medium text-orange-600">{petition.petitionId}</span>
                  </td>
                      ...
                      <div className="flex items-center space-x-2">
                        {petition.status === 'Submitted' || petition.status === 'Under Review' ? (
                          <button
                            ...
                            className="inline-flex items-center px-3 py-1 border border-orange-300 rounded-lg text-xs font-medium text-orange-700 bg-orange-50 hover:bg-orange-100 transition-colors"
                          >
