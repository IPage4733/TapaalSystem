...
const MyTappals: React.FC = () => {
  ...
  const handleForward = (tappalId: string) => {
    navigate(`/tahsildar-dashboard/forward-tappal?tappal=${tappalId}`);
  };
  ...
  const handleAddNote = (tappalId: string) => {
    showToast({
      type: 'info',
      title: 'Add Note',
      message: `Opening note editor for ${tappalId}. This feature will be available soon.`,
      duration: 4000
    });
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <p className="text-gray-600">Tappals assigned directly to you as Tahsildar</p>
      </div>
                  ...
                  <tr key={tappal.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          onClick={() => handleAddNote(tappal.tappalId)}
