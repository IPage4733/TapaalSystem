...
const MyTappals: React.FC = () => {
  ...
  const handleUploadAttachment = (tappalId: string) => {
    navigate(`/vro-dashboard/attachments?tappal=${tappalId}`);
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <p className="text-gray-600">Tappals assigned directly to you as Village Revenue Officer</p>
      </div>
                  ...
                  <tr key={tappal.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-900">{tappal.createdBy || 'System'}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
