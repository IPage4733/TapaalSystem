  ...
  const handleSubmit = () => {
    ...
    if (!remarks.trim() && attachments.length === 0) {
      showToast({
        type: 'error',
        title: 'Validation Error',
        message: 'Please add either remarks or attachments before submitting.'
      });
      return;
    }
    ...
    // 2. Add remarks to tappal comments
    // 3. Update tappal's attachments array
    // 4. Create audit log

    showToast({
      type: 'success',
      title: 'Field Notes Uploaded Successfully',
      message: `Your field notes and attachments have been added to ${selectedTappal.tappalId}.`,
      duration: 6000
    });
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Upload Field Notes & Attachments</h1>
        <p className="text-gray-600">Add field notes, remarks, and documents to your assigned tappals</p>
      </div>
      ...
      {/* Upload Form */}
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Upload Field Notes</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              placeholder="Enter your field notes, observations, and remarks about this tappal..."
            />
            <p className="text-xs text-gray-500 mt-1">
              Your remarks will be timestamped and logged against the tappal.
            </p>
          </div>
          ...
          <div className="flex items-center justify-end space-x-3">
            ...
            <button
              ...
              disabled={!selectedTappal || (!remarks.trim() && attachments.length === 0)}
