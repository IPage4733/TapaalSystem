...
const MyTappals: React.FC = () => {
  ...
  const handleForward = (tappalId: string) => {
    navigate(`/joint-collector-dashboard/forward-tappal?tappal=${tappalId}`);
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <p className="text-gray-600">Tappals assigned directly to you as Joint Collector</p>
      </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        <button
                          ...
                          className="inline-flex items-center px-3 py-1 border border-indigo-300 rounded-lg text-xs font-medium text-indigo-700 bg-indigo-50 hover:bg-indigo-100 transition-colors"
                        >
